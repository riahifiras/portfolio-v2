...
export default function ProjectPopup({ info, onClose }) {
    ...
    return (
        ...
        <div className="flex bg-white lg:flex-row flex-col lg:h-[540px] lg:translate-y-0 -translate-y-24 h-[60vh] lg:w-[1000px] w-[80%] rounded-lg" ref={popupRef}>
            <div className="relative lg:h-[540px] overflow-hidden min-h-[200px] w-full bg-transparent ">
                                    ...
                                    <div key={index} className="relative group">
                                        <div className="flex justify-center items-center">
                                            <Image
                                                src={tech.icon}
                                                alt={tech.name}
                                                className="transition-transform duration-300 transform group-hover:scale-110 lg:h-12 lg:w-12 h-8 w-8"
                                            />
                                        </div>
                                ...
                                {info.collaborators.map((collaborator, index) => (
                                    <div key={index} className="relative group">
                                        <Image
                                            ...
                                            className="rounded-full lg:w-16 lg:h-16 w-10 h-10 transition-transform duration-300 transform object-cover group-hover:scale-110"
                                        />
